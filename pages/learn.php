        ...
        <div class="categories" role="group" aria-label="Basic example">
            <div class="categories-buttons">
                ...
                ?>
                    ...
                    <a href="index.php?page=learn&section=apps&slug=education-apps" class="btn btn-secondary yellow"><img src="assets/book-open-text.svg" alt="">Education</a>
                    <a href="index.php?page=learn&section=apps&slug=quiz-apps" class="btn btn-secondary yellow"><img src="assets/shield-question.svg" alt="">Quiz</a>
                    <a href="index.php?page=learn&section=apps&slug=courses-apps" class="btn btn-secondary yellow"><img src="assets/graduation-cap.svg" alt="">Courses</a>

                <?php
                } elseif ($nom_section == "articles") {
                    $tag_name = ucfirst(str_replace("-articles", "", $slug));
                    $btn_name = "Read";
                ?>
                    <a href="index.php?page=learn&section=articles&slug=tech-articles" class="btn btn-secondary yellow"><img src="assets/cpu.svg" alt="">Tech</a>
                    <a href="index.php?page=learn&section=articles&slug=music-articles" class="btn btn-secondary yellow"><img src="assets/music.svg" alt="">Music</a>
                    <a href="index.php?page=learn&section=articles&slug=astrology-articles" class="btn btn-secondary yellow"><img src="assets/atom.svg" alt="">Astrology</a>
                <?php
                } elseif ($nom_section == "e-books") {
                    $tag_name = "EBooks";
                    $btn_name = "Read";
                ?>
                    <a href="index.php?page=learn&section=articles&slug=ebooks" class="btn btn-secondary yellow"><img src="assets/file-text.svg" alt="">eBooks</a>
                <?php
                } else {
                    $tag_name = "Audio Books";
                    $btn_name = "Listen";
                ?>
                    <a href="index.php?page=learn&section=audio-books&slug=audio-books" class="btn btn-secondary yellow"><img src="assets/audio-file.svg" alt="">Audio Books</a>
                <?php
                }
                ?>
            ...
            <div class="col-lg-3 col-md-4 col-12 my-3 col">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="border-btn"><a class="card-btn yellow-btn" href="index.php?page=single&section=<?= $slug ?>&item=<?= $item->id ?>"><?= $btn_name ?></a></div>
                    </div>
                    <div class="card-body">
