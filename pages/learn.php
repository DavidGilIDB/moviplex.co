...
$arr = match ($nom_section) {
    "apps" => ["education-apps", "apps"],
    "articles" => ["tech-articles", "articles"],
    "e-books" => ["ebooks", "apps"],
    "audio-books" => ["audio-books", "sounds"]
};
        ...
        <div class="categories" role="group" aria-label="Basic example">
            <div class="categories-buttons">
                ...
                ?>
                    ...
                    <a href="index.php?page=learn&section=apps&slug=education-apps" class="btn btn-secondary yellow tag-icon"><img src="assets/book-open-text.svg" alt="" class="tag-icon">Education</a>
                    <a href="index.php?page=learn&section=apps&slug=quiz-apps" class="btn btn-secondary yellow tag-icon"><img src="assets/shield-question.svg" alt="" class="tag-icon">Quiz</a>
                    <a href="index.php?page=learn&section=apps&slug=courses-apps" class="btn btn-secondary yellow tag-icon"><img src="assets/graduation-cap.svg" alt="" class="tag-icon">Courses</a>
                ...
                ?>
                    ...
                    <a href="index.php?page=learn&section=articles&slug=tech-articles" class="btn btn-secondary yellow tag-icon"><img src="assets/cpu.svg" alt="" class="tag-icon">Tech</a>
                    <a href="index.php?page=learn&section=articles&slug=music-articles" class="btn btn-secondary yellow tag-icon"><img src="assets/music.svg" alt="" class="tag-icon">Music</a>
                    <a href="index.php?page=learn&section=articles&slug=astrology-articles" class="btn btn-secondary yellow tag-icon"><img src="assets/atom.svg" alt="" class="tag-icon">Astrology</a>

                <?php
                } elseif ($nom_section == "e-books") {
                    $btn_name = "Read";
                ?>

                    <a href="index.php?page=learn&section=e-books&slug=ebooks" class="btn btn-secondary yellow tag-icon"><img src="assets/file-text.svg" alt="" class="tag-icon">eBooks</a>
                ...
                ?>
                    ...
                    <a href="index.php?page=learn&section=audio-books&slug=audio-books" class="btn btn-secondary yellow tag-icon"><img src="assets/audio-file.svg" alt="" class="tag-icon">Audio Books</a>
