        ...
        <div class="categories" role="group" aria-label="Basic example">
            <div class="categories-buttons">
                ...
                ?>
                    ...
                    <a href="index.php?page=enjoy&section=apps&slug=astrology-apps" class="btn btn-secondary purple tag-icon"><img src="assets/atom.svg" alt="" class="tag-icon">Astrology</a>
                    <a href="index.php?page=enjoy&section=apps&slug=lifestyle-apps" class="btn btn-secondary purple tag-icon"><img src="assets/salad.svg" alt="" class="tag-icon">Lifestyle</a>
                ...
                ?>
                    ...
                    <a href="index.php?page=enjoy&section=videos&slug=gaming-videos" class="btn btn-secondary purple tag-icon"><img src="assets/control.svg" alt="" class="tag-icon">Gaming</a>
                    <a href="index.php?page=enjoy&section=videos&slug=sport-videos" class="btn btn-secondary purple tag-icon"><img src="assets/basketball.svg" alt="" class="tag-icon">Sport</a>
                    <a href="index.php?page=enjoy&section=videos&slug=funny-videos" class="btn btn-secondary purple tag-icon"><img src="assets/laugh.svg" alt="" class="tag-icon">Funny</a>
                    <a href="index.php?page=enjoy&section=videos&slug=animal-videos" class="btn btn-secondary purple tag-icon"><img src="assets/paw.svg" alt="" class="tag-icon">Animal</a>
                    <a href="index.php?page=enjoy&section=videos&slug=documentaries" class="btn btn-secondary purple tag-icon"><img src="assets/film.svg" alt="" class="tag-icon">Documentaries</a>

                <?php
                } elseif ($nom_section == "gallery") {
                ?>

                    <a href="index.php?page=enjoy&section=gallery&slug=sport-images" class="btn btn-secondary purple tag-icon"><img src="assets/basketball.svg" alt="" class="tag-icon">Sport</a>
                    <a href="index.php?page=enjoy&section=gallery&slug=wallpapers" class="btn btn-secondary purple tag-icon"><img src="assets/screen.svg" alt="" class="tag-icon">wallpapers</a>
                    <a href="index.php?page=enjoy&section=gallery&slug=funny-images" class="btn btn-secondary purple tag-icon"><img src="assets/laugh.svg" alt="" class="tag-icon">Funny</a>
                    <a href="index.php?page=enjoy&section=gallery&slug=gaming-images" class="btn btn-secondary purple tag-icon"><img src="assets/control.svg" alt="" class="tag-icon">Gaming</a>
                    <a href="index.php?page=enjoy&section=gallery&slug=gifs-gallery" class="btn btn-secondary purple tag-icon"><img src="assets/image-down.svg" alt="" class="tag-icon">Gifs</a>
                    <a href="index.php?page=enjoy&section=gallery&slug=animals-images" class="btn btn-secondary purple tag-icon"><img src="assets/paw.svg" alt="" class="tag-icon">Animal</a>
                ...
                ?>
                    ...
                    <a href="index.php?page=enjoy&section=articles&slug=fun-facts" class="btn btn-secondary purple tag-icon"><img src="assets/lightbulb.svg" alt="" class="tag-icon">Fun Facts</a>
