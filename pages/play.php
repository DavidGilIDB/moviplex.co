...
<div class="header-title category header-blue">
  <h1><img src="assets/icon-game.svg" alt="logo" />Play</h1>
</div>
<div class="container py-2">
    ...
    <div class="row py-2 justify-content-center overflow-auto">
      <div class="categories" role="group" aria-label="Basic example">
        <div class="categories-buttons">
          <a class="btn btn-secondary blue tag-icon" href="index.php?page=play&section=games&slug=action-games"><img src="assets/sword.svg" alt="" class="tag-icon">Action</a>
          <a class="btn btn-secondary blue tag-icon" href="index.php?page=play&section=games&slug=adventure-games"><img src="assets/rocket.svg" alt="" class="tag-icon">Adventure</a>
          <a class="btn btn-secondary blue tag-icon" href="index.php?page=play&section=games&slug=arcade-games"><img src="assets/ghost.svg" alt="" class="tag-icon">Arcade </a>
          <a class="btn btn-secondary blue tag-icon" href="index.php?page=play&section=games&slug=exclusive"><img src="assets/sun.svg" alt="" class="tag-icon"> Exclusives</a>
          <a class="btn btn-secondary blue tag-icon" href="index.php?page=play&section=games&slug=music-games"><img src="assets/music.svg" alt="" class="tag-icon">Music</a>
          <a class="btn btn-secondary blue tag-icon" href="index.php?page=play&section=games&slug=online-games"><img src="assets/wifi.svg" alt="" class="tag-icon">Online</a>
          <a class="btn btn-secondary blue tag-icon" href="index.php?page=play&section=games&slug=racing-games"><img src="assets/car.svg" alt="" class="tag-icon">Racing</a>
          <a class="btn btn-secondary blue tag-icon" href="index.php?page=play&section=games&slug=simple-games"><img src="assets/puzzle.svg" alt="" class="tag-icon">Simple</a>
          <a class="btn btn-secondary blue tag-icon" href="index.php?page=play&section=games&slug=sport-games"> <img src="assets/basketball.svg" alt="" class="tag-icon">Sport</a>
          <a class="btn btn-secondary blue tag-icon" href="index.php?page=play&section=games&slug=strategy-games"><img src="assets/castle.svg" alt="" class="tag-icon">Strategy</a>
        </div>
      </div>
    </div>
  ...
  ?>
    ...
    <div class="row py-2 justify-content-center overflow-auto">
      <div class="categories" role="group" aria-label="Basic example">
        <div class="categories-buttons">
          <a class="btn btn-secondary blue tag-icon" href="index.php?page=play&section=articles&slug=gaming-tips"><img src="assets/message.svg" alt="" class="tag-icon"> Gaming Tips</a>
          <a class="btn btn-secondary blue tag-icon" href="index.php?page=play&section=articles&slug=gaming-reviews"><img src="assets/star.svg" alt="" class="tag-icon"> Gaming Reviews</a>
          <a class="btn btn-secondary blue tag-icon" href="index.php?page=play&section=articles&slug=sport-articles"><img src="assets/basketball.svg" alt="" class="tag-icon"> Sport </a>
        </div>
      </div>
    </div>
