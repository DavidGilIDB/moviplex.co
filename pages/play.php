...
$sections = ["moira-action-games" => ['type' => 'games'], "moira-adventure-games" => ['type' => 'games'], "moira-arcade-games" => ['type' => 'games'], 
"moira-exclusive" => ['type' => 'games'], "moira-music-games" => ['type' => 'games'], "moira-online-games" => ['type' => 'games'], 
"moira-racing-games" => ['type' => 'games'], "moira-simple-games" => ['type' => 'games'], "moira-sport-games" => ['type' => 'games'], 
"moira-strategy-games" => ['type' => 'games'], "moira-recently-added" => ['type' => 'games'], "moira-top-games" => ['type' => 'games']];
...
<div class="container py-2">
  <div class="row py-2 justify-content-center overflow-auto">
    <div class="categories" role="group" aria-label="Basic example">
      <div class="categories-buttons">
        ...
        <a class="btn btn-secondary blue tag-icon" href="/play/games/adventure-games">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
        ...
        <a class="btn btn-secondary blue tag-icon" href="/play/games/arcade-games"><svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
            viewBox="0 0 24 24"
          ...
          Arcade </a><a class="btn btn-secondary blue tag-icon" href="/play/games/exclusives-games"><svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
            viewBox="0 0 24 24"
        ...
        <a class="btn btn-secondary blue tag-icon" href="/play/games/music-games"><svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
            viewBox="0 0 24 24"
          ...
          Music</a><a class="btn btn-secondary blue tag-icon" href="/play/games/online-games"><svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
            viewBox="0 0 24 24"
          ...
          Online</a><a class="btn btn-secondary blue tag-icon" href="/play/games/racing-games"><svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
            viewBox="0 0 24 24"
          ...
          Racing</a><a class="btn btn-secondary blue tag-icon" href="/play/games/simple-games"><svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
            viewBox="0 0 24 24"
          ...
          Simple</a><a class="btn btn-secondary blue tag-icon" href="/play/games/sport-games"><svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
            viewBox="0 0 24 24"
          ...
          Sport</a><a class="btn btn-secondary blue tag-icon" href="/play/games/strategy-games"><svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
            viewBox="0 0 24 24"
  ...
  <div class="row">
    ...
    foreach ($result as $key => $value) {
      foreach ($value['response'] as $key => $play) {
        
    ?>
        <div class="col-lg-3 col-md-4 col-12 my-3 col">
          <div class="card">
            <div class="card-header">
              <a href="<?= $play->src ?>"><img loading="lazy" src="<?= STORAGEURL . $play->image ?>" alt="game" /></a>
              <div class="border-btn"><a class="card-btn blue-btn" href="<?= $play->src ?>">Play</a></div>
            </div>
            <div class="card-body">
              <h3 class="card-title"><?= $play->name ?></h3>
              <p class="card-text">
                <?= $play->description ?>
              </p>
              <div class="card-info">
