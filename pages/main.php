...
if ($_GET['page'] == "watch") {
  ...
  $top = getSection($section[$_GET['page']][0][1], "en", $section[$_GET['page']][0][0]);
}
...
<noscript>
  <iframe
    src="https://www.googletagmanager.com/ns.html?id=GTM-W75M7VJV"
    height="0"
    width="0"
...
switch ($_GET['page']) {
  case 'play':
    include "components/play-main.php";
    break;
  case 'watch':
    include "components/watch-main.php";
    break;
  case 'fitness':
    ...
    <div class="section-container">
      <div class="swiper swiper-initialized swiper-horizontal mySwiper swiper-backface-hidden">
        <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px)">
          ...
          <?php
          foreach ($exclusives[0] as $article) {
          ?>
