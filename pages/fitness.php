...
<div class="container py-2">
    ...
    <div class="row py-2 justify-content-center overflow-auto">
      <div class="categories" role="group" aria-label="Basic example">
        <div class="categories-buttons">
          <a class="btn btn-secondary green tag-icon" href="index.php?page=fitness&section=apps&slug=beauty-apps"><img src="assets/heart.svg" alt="" class="tag-icon">Beauty</a>
          <a class="btn btn-secondary green tag-icon" href="index.php?page=fitness&section=apps&slug=health-fitness-apps"><img src="assets/apple.svg" alt="" class="tag-icon">Health &amp; Fitness</a>
        </div>
      </div>
    </div>
  ...
  ?>
    ...
    <div class="row py-2 justify-content-center overflow-auto">
      <div class="categories" role="group" aria-label="Basic example">
        <div class="categories-buttons">
          <a class="btn btn-secondary green tag-icon" href="index.php?page=fitness&section=videos&slug=health-fitness-videos"><img src="assets/apple.svg" alt="" class="tag-icon">Health &amp; Fitness</a>
          <a class="btn btn-secondary green tag-icon" href="index.php?page=fitness&section=videos&slug=cardio"><img src="assets/cardio.svg" alt="" class="tag-icon">Cardio</a>
          <a class="btn btn-secondary green tag-icon" href="index.php?page=fitness&section=videos&slug=stretching-and-warmup-exercises"><img src="assets/person.svg" alt="" class="tag-icon">Streching</a>
          <a class="btn btn-secondary green tag-icon" href="index.php?page=fitness&section=videos&slug=lower-back-arms-and-legs-exercises"><img src="assets/dumbbell.svg" alt="" class="tag-icon">Lower Back</a>
          <a class="btn btn-secondary green tag-icon" href="index.php?page=fitness&section=videos&slug=meditation"><img src="assets/leaf.svg" alt="" class="tag-icon">Meditation</a>
          <a class="btn btn-secondary green tag-icon" href="index.php?page=fitness&section=videos&slug=full-body"><img src="assets/person.svg" alt="" class="tag-icon">Full Body</a>
          <a class="btn btn-secondary green tag-icon" href="index.php?page=fitness&section=videos&slug=abs-and-chest-exercises"><img src="assets/dumbbell.svg" alt="" class="tag-icon">Abs</a>
        </div>
      </div>
    </div>

  <?php
  } elseif ($nom_section == "images") {
  ?>

    <div class="categories-buttons">
      <a class="btn btn-secondary green tag-icon" href="index.php?page=fitness&section=images&slug=health-fitness-images"><img src="assets/apple.svg" alt="" class="tag-icon">Health &amp; Fitness</a>
      <a class="btn btn-secondary green tag-icon" href="index.php?page=fitness&section=images&slug=lifestyle-images"><img src="assets/salad.svg" alt="" class="tag-icon">Lifestyle</a>
    </div>
        ...
        <div class="col-lg-3 col-md-4 col-12 my-3 col <?= ((!isset($_SESSION["login"]) || !$_SESSION["login"]) && ($nom_section == "articles" || $nom_section == "videos")) ? 'noLogin' : "" ?>">
          <div class="card">
            <div class="card-header">
              ...
              <div class="border-btn"><a class="card-btn green-btn" <?= ((!isset($_SESSION["login"]) || !$_SESSION["login"]) && ($nom_section == "articles" || $nom_section == "videos")) ? '' : "href=index.php?main=fitness&page=single&section=" . $slug . "&item=" . $item->id ?>><?= $btn_name ?></a></div>
            </div>
            <div class="card-body">
