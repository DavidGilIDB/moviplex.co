<div class="header-title category header-green">
    <h1><img src="assets/icon-train.svg" alt="logo" />Train</h1>
</div>
<div class="latestUpdate bckPlay">
        ...
        <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px)">
            ...
            ?>
                ...
                <div class="swiper-slide swiper-slide-active <?= (!isset($_SESSION["login"]) || !$_SESSION["login"]) ? "noLogin" : "" ?>" style="width: 255.2px; margin-right: 30px">
                    <a><img src="<?= STORAGEURL . $app->image ?>" alt="" /></a>
                </div>
    ...
    <a class="section-btn mt-4 d-block m-auto btnGreen" href="index.php?page=fitness&section=videos&slug=lower-back-arms-and-legs-exercises">See All</a>
</div>
...
<div class="main-sections">
    <a class="category-card green " href="index.php?page=fitness&section=apps&slug=moira-beauty">
    ...
    <a class="category-card green " href="index.php?page=fitness&section=videos&slug=health-fitness-videos">
        <div class="category-card-content">
            <h3> Videos</h3>
    ...
    <a class="category-card green " href="index.php?page=fitness&section=gallery&slug=health-fitness-images">
        <div class="category-card-content">
            <h3> Gallery</h3>
        ...
        <div id="topArticlesSection">
            <div class="d-flex justify-content-center flex-column">
                <div class="topArticlesTitle d-flex justify-content-between align-items-center">
                    <h2>Top Articles</h2><a href="index.php?page=fitness&section=articles&slug=lifestyle-articles">See All</a>
                </div>
    ...
    <div>
        <div id="topArticlesSection">
            <div class="d-flex justify-content-center flex-column">
                <div class="topArticlesTitle d-flex justify-content-between align-items-center">
                    <h2>Top Articles</h2>
                    <a href="index.php?page=fitness&section=articles&slug=gaming-tips">See All</a>
                </div>
                <div class="container d-flex gap-4 justify-content-center mt-5 articles-frame">
