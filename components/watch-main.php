...
<div class="latestUpdate bckPlay">
    ...
    <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px)">
      ...
      <?php foreach ($recents as $app) { ?>
        <div class="swiper-slide swiper-slide-active <?= (!isset($_SESSION["login"]) || !$_SESSION["login"]) ? "noLogin" : "" ?>" style="width: 255.2px; margin-right: 30px">
          <a href="#"><img src="<?= 'assets/images/films/cover/' . $app->image; ?>" /></a>
        </div>
      <?php } ?>
    </div>
  ...
  <a class="section-btn mt-4 d-block m-auto btnRed" href="#/games/action-games">See All</a>
</div>
...
<div class="main-sections">
  ...
  </a><a class="category-card red " href="index.php?page=watch&section=thriller">
    <div class="category-card-content">
      <h3> Thriller</h3>
      <p>Be frightened by our horror films and cult thrillers</p>
    </div><img class="category-card-image" src="assets/watch-thriller.png" alt="Games">
  </a><a class="category-card red " href="index.php?page=watch&section=documentary">
    <div class="category-card-content">
      <h3> Documentaries</h3>
      <p>Discover everything about the most popular characters</p>
    </div><img class="category-card-image" src="assets/watch-docs.png" alt="Games">
  </a><a class="category-card red " href="index.php?page=watch&section=drama">
    <div class="category-card-content">
      <h3> Drama</h3>
      <p>Great stories that will touch you in your heart</p>
    </div><img class="category-card-image" src="assets/watch-drama.png" alt="Games">
  </a><a class="category-card red " href="index.php?page=watch&section=kids">
    <div class="category-card-content">
      <h3> Kids</h3>
      <p>The best children's content to entertain your kids</p>
    </div><img class="category-card-image" src="assets/watch-kids.png" alt="Games">
  </a>
  <div></div>
</div>