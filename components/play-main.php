...
<div class="latestUpdate bckPlay">
  ...
  <a class="section-btn mt-4 d-block m-auto btnBlue" href="index.php?page=play&section=games&slug=action-games">See All</a>
</div>
    ...
    <div id="topArticlesSection">
      <div class="d-flex justify-content-center flex-column">
        <div class="topArticlesTitle d-flex justify-content-between align-items-center">
          <h2>Top Articles</h2>
          <a href="index.php?page=play&section=articles&slug=gaming-tips">See All</a>
        </div>
